...
public class Sample15_SampleTextMemory
{
    ...
    private static async Task RunWithStoreAsync(IMemoryStore memoryStore, CancellationToken cancellationToken)
    {
        var kernel = new KernelBuilder()
            ...
            .WithOpenAIChatCompletionService(Constants.OpenAIChatModel, Constants.OpenAIToken)
            .WithOpenAITextEmbeddingGenerationService(Constants.OpenAIEmbeddingModel, Constants.OpenAIToken)
            .Build();
