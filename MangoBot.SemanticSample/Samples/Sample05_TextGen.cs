...
";
        ...
        var excuseFunction = kernel.CreateSemanticFunction(promptTemplate,
            new OpenAIRequestSettings() { MaxTokens = 100, Temperature = 0.4, TopP = 1 });
        ...
        var fixedFunction = kernel.CreateSemanticFunction(
